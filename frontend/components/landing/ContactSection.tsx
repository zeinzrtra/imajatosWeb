...
export function ContactSection() {
  ...
  return <section id="kontak" className="landing-section" aria-labelledby="kontak-title">
    <div className="landing-section-heading contact-heading"><div className="shell"><span>Kontak & Pengaduan</span><h2 id="kontak-title">Hubungi kami untuk mulai berkolaborasi.</h2><p>Punya pertanyaan, peluang sponsorship, ide partnership, atau pengaduan? Tim kami siap membantu.</p></div></div>
    <div className="section shell contact-layout"><aside><span className="mini-label">Kontak Kami</span><h2>Kami terbuka untuk berbagai bentuk kolaborasi.</h2><p>Informasi kontak resmi akan ditampilkan setelah diverifikasi oleh IMAJATOS.</p><div className="contact-list"><div><Mail /><span><small>Email</small><strong>Menunggu data resmi</strong></span></div><div><Phone /><span><small>Telepon / WhatsApp</small><strong>Menunggu data resmi</strong></span></div><div><MapPin /><span><small>Sekretariat</small><strong>Menunggu data resmi</strong></span></div><div><Clock3 /><span><small>Jam layanan</small><strong>Menunggu data resmi</strong></span></div></div><div className="instagram-card"><Instagram /><span><small>Media sosial</small><strong>Menunggu akun resmi</strong></span></div></aside>
