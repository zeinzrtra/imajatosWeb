...
export function AboutSection() {
  return <section id="tentang" className="landing-section" aria-labelledby="tentang-title">
    <div className="section shell about-editorial">
      <div><SectionTitle eyebrow="Tentang Kami" title="Organisasi yang tumbuh dari jalur dan pengalaman yang sama." /><p>IMAJATOS menjadi ruang bersama bagi mahasiswa IPB University yang diterima melalui jalur Ketua OSIS. Di dalamnya, pengurus inti bekerja bersama biro dan departemen untuk menjalankan organisasi.</p><p>Sejarah, visi, misi, dan tonggak perjalanan akan ditambahkan dari dokumen atau wawancara resmi agar cerita yang tampil tetap akurat.</p></div>
    ...
    <div id="struktur" className="section structure-section landing-anchor"><div className="shell"><div className="landing-intro-row"><SectionTitle eyebrow="Struktur Organisasi" title="Kenali orang-orang di balik IMAJATOS." text="Arahkan kursor untuk menyorot kartu, lalu klik untuk membuka profil pengurus, biro, atau departemen. Seluruh data yang belum resmi tetap ditandai sebagai placeholder." /></div><OrganizationStructure /></div></div>
  </section>;
}
