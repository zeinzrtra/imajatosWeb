...
export default function KontakPage() {
  ...
  return <>
    ...
    <section className="section shell contact-layout"><aside><span className="mini-label">Kontak Kami</span><h2>Kami terbuka untuk berbagai bentuk kolaborasi.</h2><p>Tim kami akan merespons pesan dalam 1–2 hari kerja.</p><div className="contact-list"><div><Mail /><span><small>Email</small><strong>halo@imajatos.org</strong></span></div><div><Phone /><span><small>Telepon / WhatsApp</small><strong>+62 812 3456 7890</strong></span></div><div><MapPin /><span><small>Sekretariat</small><strong>Bogor, Jawa Barat</strong></span></div><div><Clock3 /><span><small>Jam layanan</small><strong>Senin–Jumat, 09.00–17.00</strong></span></div></div><a className="instagram-card" href="https://instagram.com" target="_blank" rel="noreferrer"><Instagram /><span><small>Lihat kegiatan kami</small><strong>@imajatos</strong></span></a></aside>
