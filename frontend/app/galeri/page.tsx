...
export default function GaleriPage() {
  return <>
    <section className="page-hero gallery-hero"><div className="shell"><span>Galeri & Dokumentasi</span><h1>Momen yang merekam<br />semangat kebersamaan.</h1><p>Sepenggal cerita dari setiap langkah, senyum, dan kerja baik yang kami lakukan bersama.</p></div></section>
